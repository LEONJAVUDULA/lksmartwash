...
import { MapPin, Truck, Clock, Award, Phone, ArrowRight, ShieldCheck, Shirt } from 'lucide-react';
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mt-8">
                        ...
                        <a href={businessInfo.catalogUrl} target="_blank" rel="noopener noreferrer">
